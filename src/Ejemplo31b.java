...
public class Ejemplo31b extends Thread{
	...
	//Constructor
	public Ejemplo31b(int pIdThread, int pFila){
	...
	public static void main(String[] args)
	{
		...
		//Iniciar la matriz
		Ejemplo31b.crearMatriz();
		System.out.println();
		System.out.println("Iniciando la busqueda por la matriz \n");
		
		//Iniciar busqueda
		Ejemplo31b[] bThreads=new Ejemplo31b[DIM];
		for(int i=0;i<DIM;i++)
		{
			bThreads[i]=new Ejemplo31b(i,i);
			bThreads[i].start();
		}
	}
}
